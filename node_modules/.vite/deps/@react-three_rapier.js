import {
  ...
  sg,
  wI
} from "./chunk-RU7ITTQE.js";
import {
  mergeVertices
} from "./chunk-7VCEZKOH.js";
import {
  suspend,
  useFrame,
  useThree
} from "./chunk-IFXUPVV7.js";
import {
  BufferAttribute,
  DynamicDrawUsage,
  Euler,
...
var useRapier = () => {
  ...
  if (!rapier)
    throw new Error("react-three-rapier: useRapier must be used within <Physics />!");
  return rapier;
};
...
var importRapier = async () => {
  let r = await import("./rapier.es-I4DHSXCQ.js");
  await r.init();
  return r;
};
var Physics = (props) => {
